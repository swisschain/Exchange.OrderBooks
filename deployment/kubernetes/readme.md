1. Copy `Exchange-OrderBooks` and `Exchange-OrderBooks-Worker` to the https://github.com/swisschain/kubernetes-swisschain/tree/master/Kubernetes/03.Pods/Exchange. 
